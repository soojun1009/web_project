	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-9 text-left" id = "content">
				<h1 style="margin-bottom: 20px">성적관리<small>데이터베이스 [2016-11-30 ~ 2016-12-31]</small></h1>
				<div class="grade">
					...
					<table class="table table-default">
						...
						<tbody>
							<tr>
								...
								<td>30</td>
								<td>30</td>
								<td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeInsertFormModal" disabled>
										등록 <span class="badge"></span>
									</button>
									<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeUpdateFormModal">
										수정 <span class="badge"></span>
									</button>
									<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeDeleteFormModal">
							...
							<tr>
								...
								<td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeInsertFormModal" disabled>
									...
									<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeUpdateFormModal" disabled>
										수정 <span class="badge"></span>
									</button>
									<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeDeleteFormModal" disabled>
										삭제 <span class="badge"></span>
									</button></td>
							</tr>
							...
							<tr>
								...
								<td>X</td>
								<td>X</td>
								<td><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeInsertFormModal">
										등록 <span class="badge"></span>
									</button>
									<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#gradeUpdateFormModal" disabled>
										수정 <span class="badge"></span>
					...
					<form action="gradeinsert.jsp" method="post">
						...
						<div class="form-group">
							...
							<label for="name1">이름(readonly):</label> <input type="text"
								class="form-control" id="name" name="name" required readonly value="이수준">
						</div>
						...
						<div class="form-group">
							...
							<label for="subjectname">과목명:</label> <input type="text"
								class="form-control" id="b" name="b" required readonly value = "데이터베이스">								
						</div>
							<div class="form-group">
							<!-- id="" 속성에서 식별자 작성시 현재 페이지 내에서 유일하도록 작성할 것. -->
							<label for="subjectnameperiod">과목기간:</label> <input type="text"
								class="form-control" id="b" name="b" required readonly value = "2016-11-30 ~ 2016-12-31">								
						</div>
						<div class="form-group">
							<label for="subject1">출결성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="c" name="c" required>
								<span class="help-block">(배점:20)</span>
						</div>
						<div class="form-group">
							<label for="subject2">필기성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="d" name="d" required>
									<span class="help-block">(배점:40)</span>
						</div>
						<div class="form-group">
							<label for="subject3">실기성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="e" name="e" required>
									<span class="help-block">(배점:40)</span>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="gradeinsert.jsp" method="post">
						...
						<div class="form-group">
							<label for="subject1">출결성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="c" name="c" required value = "30">
								<span class="help-block">(배점:20)</span>
						</div>
						<div class="form-group">
							<label for="subject2">필기성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="d" name="d" required value = "40">
									<span class="help-block">(배점:40)</span>
						</div>
						<div class="form-group">
							<label for="subject3">실기성적 :</label> <input type="number"  min="0" max="100"
								class="form-control" id="e" name="e" required value = "40">
									<span class="help-block">(배점:40)</span>
						</div>
						<button type="submit" class="btn btn-default">등록</button>
